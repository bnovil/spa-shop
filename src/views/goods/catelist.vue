              ...
              <div class="wall-col fl clearfix" style="width:50%;">
                <div class="clearfix scroll-remove layer-3d scroll-remove0">
                  ...
                  <div class="iwf" v-for="item in list">
                    <a v-link="{name:'catedetail',params:{mt:item.id}}"
                       class="img-wrap J_dynamic_imagebox loading_bg_110" style="padding-bottom: 150%;">
                      <div class="img-tags clearfix" v-if="item.imgtag">
                        <img class="img-tag fl"
                             src="http://s16.mogucdn.com/p1/160309/upload_ifrgeoldgeywcmjtg4zdambqmeyde_76x76.png"
                             style="width:0.73rem;">
                      </div>
                      <img :src="item.pic" :alt="item.title">
                    </a>
                    <div><p class="title"><a v-link="{name:'catedetail',params:{mt:item.id}}">{{item.title}}</a></p>
                    </div>
                    <div class="goods_info">
                      <div class="fav_num"><em>￥</em>{{item.price}}</div>
                      <div class="count">{{item.count}}</div>
                      <div class="img"><img
                        src="http://s16.mogucdn.com/p1/160223/upload_ie3timrrhazdqndfgyzdambqgayde_28x36.jpg"></div>
                    </div>
